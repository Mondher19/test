 ...
 * Use the [ChooseTransportAdmin.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChooseTransportAdmin : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_choose_transport_admin, container, false)

        val btnbus: ImageView = view.findViewById(R.id.Busbtnadmin)
        val trainbtn: ImageView = view.findViewById(R.id.Trainbtnadmin)
        val metrobtn: ImageView = view.findViewById(R.id.Metrobtnadmin)

        btnbus.setOnClickListener {
            val stationsFragment = stationsadmin()
            val bundle = Bundle()
