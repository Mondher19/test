...
class stationadminAdapter(private var mList: List<station>) : RecyclerView.Adapter<stationadminAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.stationrsadmin, parent, false)
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        val name: TextView = itemView.findViewById(R.id.stationnameadmin)
        val type: TextView = itemView.findViewById(R.id.typestationadmin)
