...
class transportAdapter(private var mList: List<transport>) : RecyclerView.Adapter<transportAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.transportrs, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            val fragment = TransportDetailsFragment.newInstance(holder.name.text.toString(), holder.price.text.toString(), schedule, destinantion, type)
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        val name: TextView = itemView.findViewById(R.id.nametransport)
        val price: TextView = itemView.findViewById(R.id.pricetransport)
